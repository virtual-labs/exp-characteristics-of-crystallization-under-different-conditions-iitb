...
function activity5() {
    ...
    pp.clearrightpannel();
    pp.addoffcanvas(3);
    pp.showtitle(`<div id="exp-title">To study the characteristics of crystallization under different conditions</div>`, 3);
    pp.showdescription(`<div style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: calc(1vw + 12px);">Calculate the values using shown formulae</div>`, 3);
    ...
    left_container.innerHTML += activity5_formulae;
    let act5_inputs = `
    ...
    left_container.innerHTML += act5_inputs;
    ...
    `;
    left_container.innerHTML += percentage_inputs;
    pp.addtoleftpannel(left_container.outerHTML);
