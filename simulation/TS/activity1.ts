...
var scene: Scene;
var rect;
var cc:HTMLDivElement=<HTMLDivElement>document.getElementById("pannelcreate");
...
function a1_draw_all_components() {
    var sq=new Chemistry.Custome_image(beaker,new Chemistry.Point(300,500),291, 408,canvas);
    sq.name="beaker";
    scene.add(sq);
    var sq=new Chemistry.Custome_image(magnetic_stirrer,new Chemistry.Point(1000,500),401, 141.86,canvas);
    sq.name="magnetic_stirrer";
    scene.add(sq);
    var sq=new Chemistry.Custome_image(thermometer,new Chemistry.Point(1650,500),59, 532,canvas);
    sq.name="thermometer";
    scene.add(sq);
}
...
{
    question=[];
    question.push({srno:1,question:"Select <span style='color: #018fc3'>Beaker</span>",ans:"beaker",hint:["Has Suction and Discharge","Has valve attached","Triangular Base"]});
    question.push({srno:2,question:"Select <span style='color: #018fc3'> Magnetic Strirrer </span>",ans:"magnetic_stirrer",hint:["Rectangular","Mounted Vertically","Has valves attached"]});
    question.push({srno:3,question:"Select <span style='color: #018fc3'> Thermometer </span>",ans:"thermometer",hint:["Rectangular","Mounted Vertically","Has valves attached"]});
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text("beaker",new Chemistry.Point(300,220),canvas),

        new Chemistry.Text("magnetic_stirrer",new Chemistry.Point(1000, 300),canvas),

        new Chemistry.Text("thermometer",new Chemistry.Point(1650, 200),canvas)
   ]
